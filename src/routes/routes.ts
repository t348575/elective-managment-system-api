...
const models: TsoaRoute.Models = {
    ...
    AddElectives: {
        ...
        properties: {
            ...
            batches: {
                ...
                required: true,
                validators: { pattern: { value: '^\\d{4}-\\d-[a-zA-Z]{4,5}-[a-zA-Z]{3,4}$' } }
            },
    ...
    scopes: {
        ...
        type: {
            dataType: 'union',
            subSchemas: [
                { dataType: 'enum', enums: ['teacher'] },
                { dataType: 'enum', enums: ['admin'] },
                { dataType: 'enum', enums: ['student'] }
            ],
            validators: {}
        }
    },
            ...
            files: {
                ...
                array: {
                    ...
                    nestedProperties: {
                        ...
                        file: { ref: 'IDownloadModel', required: true }
                    }
                },
                required: true
            }
    ...
    refreshToken: {
        ...
        type: {
            dataType: 'nestedObjectLiteral',
            nestedProperties: { refresh_token: { dataType: 'string', required: true } },
            validators: {}
        }
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    ITrackModel: {
        ...
        properties: {
            device: {
                dataType: 'union',
                subSchemas: [
                    { dataType: 'enum', enums: ['desktop'] },
                    { dataType: 'enum', enums: ['mobile'] },
                    { dataType: 'enum', enums: ['bot'] },
        ...
        properties: {
            ...
            sub: {
                ...
                nestedProperties: {
                    ...
                    expirationTime: { dataType: 'enum', enums: [null], required: true },
...
export function RegisterRoutes(app: express.Router) {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/oauth/authorize', function AuthController_auth(request: any, response: any, next: any) {
        const args = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/oauth/login', function AuthController_login(request: any, response: any, next: any) {
        const args = {
            request: { in: 'request', name: 'request', required: true, dataType: 'object' }
        };
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/oauth/token', function AuthController_token(request: any, response: any, next: any) {
        const args = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.put('/users/requestReset', function UsersController_requestReset(request: any, response: any, next: any) {
        const args = {
            user: {
                in: 'body',
                name: 'user',
                required: true,
                dataType: 'nestedObjectLiteral',
                nestedProperties: { user: { dataType: 'string', required: true } }
            }
        };
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/users/validReset', function UsersController_validReset(request: any, response: any, next: any) {
        const args = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.put('/users/resetPassword', function UsersController_resetPass(request: any, response: any, next: any) {
        const args = {
        ...
        function UsersController_getTrackedData(request: any, response: any, next: any) {
            const args = {
                ...
                sortBy: {
                    ...
                    dataType: 'union',
                    subSchemas: [
                        { dataType: 'enum', enums: ['ip'] },
                        { dataType: 'enum', enums: ['device'] },
                        { dataType: 'enum', enums: ['browser'] },
                        { dataType: 'enum', enums: ['platform'] },
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get(
        '/downloads/class-resource/tracked',
        authenticateMiddleware([{ jwt: ['admin', 'teacher'] }]),
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post(
        '/classes/request-elective-change',
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post(
        '/classes/confirm-elective-change',
        authenticateMiddleware([{ jwt: ['admin'] }]),
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get(
        '/classes/valid-request-electives',
        authenticateMiddleware([{ jwt: ['student'] }]),
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get(
        '/classes/can-request-elective-change',
        authenticateMiddleware([{ jwt: ['student'] }]),
        ...
        function QuizzesController_getNextQuestion(request: any, response: any, next: any) {
            const args = {
                ...
                dir: {
                    ...
                    dataType: 'union',
                    subSchemas: [
                        { dataType: 'enum', enums: ['next'] },
                        { dataType: 'enum', enums: ['prev'] }
                    ]
                },
                request: { in: 'request', name: 'request', required: true, dataType: 'object' },
